...
$page_title = $page_title ?? Helper::getMessageText('not_found', 'صفحه یافت نشد');
$app_name = $app_name ?? 'حسابداری رایان طلا';
$is_logged_in = $is_logged_in ?? false;
$base_url = $base_url ?? '/';
$error_message = $error_message ?? Helper::getMessageText('page_not_found', 'صفحه مورد نظر یافت نشد.');
        ...
        <div class="col-md-10 col-lg-8 col-xl-7">
            <div class="card shadow rounded-4 border-danger">
                <div class="card-body text-center p-5">
                    <h1 class="display-5 text-danger fw-bold mb-2"> صفحه یافت نشد-404</h1>
